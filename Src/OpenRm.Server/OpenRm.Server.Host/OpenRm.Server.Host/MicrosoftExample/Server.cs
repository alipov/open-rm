...
namespace OpenRm.Server.Host.MicrosoftExample
{
    ...
    class Server
    {
        ...
        readonly BufferManager _bufferManager;  // represents a large reusable set of buffers for all socket operations
        const int OpsToPreAlloc = 2;    // read, write (don't alloc buffer space for accepts)
        Socket _listenSocket;            // the socket used to listen for incoming connection requests
        // pool of reusable SocketAsyncEventArgs objects for write, read and accept socket operations
        readonly SocketAsyncEventArgsPool _readWritePool;
        ...
        public Server(int numConnections, int receiveBufferSize)
        {
            ...
            //m_receiveBufferSize = receiveBufferSize; // Alex: no usage
